...
const PublicNav = () => {
    const activePage = {
        Register: "src/assets/register-active.png",
        Login: "src/assets/login-active.png",
        Home: "src/assets/home-active.png"
    }
    const links = [
        { text: "Home", to: "/", img: "src/assets/home.png", activeIcon: activePage.Home },
        { text: "Register", to: "/Register", img: "src/assets/register.png", activeIcon: activePage.Register },
        { text: "Login", to: "/Login", img: "src/assets/login.png", activeIcon: activePage.Login },
    ]
    return (
