            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <div className="flex flex-wrap items-start">
                    <div className="w-full  pr-4">
                        <div className="flex flex-col gap-7">
                            <div className="text-center">
                                <h2 className="text-5xl">About VetNova and our services for you</h2>
                            </div>
                            <div className='flex flex-wrap justify-between'>
                                <div className="lg:w-1/3 pl-10 flex flex-col gap-3 mt-7">
                                    <p className="text-gray-800">
                                ...
                                <div className="w-full md:w-1/2 lg:w-1/2 mt-4 md:mt-0 text-center">
                                    <div className="flex justify-between gap-12">
                                        <div className="flex flex-col items-center">
                                            <img src="src/assets/turnos.png" alt="icono-turnos" className="w-20 h-20 object-cover rounded-full mb-2 bg-[#FAE7D5]" />
                                            <h3>Shifts</h3>
                                            <p className="text-sm text-center">Schedule your appointment and give your pet the care it deserves!</p>
                                        </div>
                                        <div className="flex flex-col items-center">
                                            <img src="src/assets/haircut.png" alt="icono-Bathing" className="w-20 h-20 object-cover rounded-full bg-[#FAE7D5] mb-2" />
                                            <h3>HairCut's</h3>
                                            <p className="text-sm text-center">We offer professional haircuts to keep your pet comfortable and well-groomed.</p>
                                        </div>
                                        <div className="flex flex-col items-center">
                                            <img src="src/assets/maps.png" alt="icono-Rutina" className="w-20 h-20 object-cover rounded-full mb-2 bg-[#FAE7D5]" />
                                            <h3>Find Us</h3>
